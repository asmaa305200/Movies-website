...
export class MoviesApiService {
  ...
  trending(): Observable<any>{
    return this._HttpClient.get(`${this.baseurl}/trending/movie/day?api_key=${this.apikey}`);
  }
  getSearchMovie(data: any): Observable<any> {
    console.log(data, 'movie#');

    return this._HttpClient.get(`${this.baseurl}/search/movie?api_key=${this.apikey}&query=${data.movieName}`);
  }
  ...
  getMovieVideo(data: any): Observable<any> {
    return this._HttpClient.get(`${this.baseurl}/movie/${data}/videos?api_key=${this.apikey}`)
  }

  // getMovieCast
  getMovieCast(data: any): Observable<any> {
    return this._HttpClient.get(`${this.baseurl}/movie/${data}/credits?api_key=${this.apikey}`)
  }
  // action 
